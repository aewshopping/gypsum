...
Related: `plans/completed/table-value-types.md`, `plans/completed/table-cell-editors.md` and
`plans/completed/table-cell-writing.md`, all of which depend on this and were split from the plan this was
itself split out of.
