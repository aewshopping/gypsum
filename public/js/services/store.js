...
export const FILE_PROPERTIES = {
  ...
  id: { type: 'number', column_width: 80, display_order: 9 },
  title: { type: 'string', column_width: 550, display_order: 2 },
  ...
  color: { type: 'string', column_width: 0, display_order: 99 },
...
export const TABLE_VIEW_COLUMNS = {
  hidden: ['fileHandle', 'show', 'color', 'content'],
  available: ['date', 'phone', 'email', 'sizeInBytes', 'id', 'tags_parent'],
  default: ['filename', 'title', 'tags', 'lastModified'],
};
