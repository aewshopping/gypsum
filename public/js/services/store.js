...
export const appState = {
  ...
  // forcing it. plans/completed/table-delete-column.md §8.
  //
...
export const FILE_PROPERTIES = new Map([
  ...
  // 175 rather than 150: the header carries a type glyph as well as the sort chevron, and at 150 the
  // longest default heading in the table no longer fitted beside both. It went to 195 when a locked
  // column wore a second glyph, and came back when the two became one.
  ['lastModified', {label: 'last modified', type: 'datetime', column_width: 175, display_order: 4 }],
