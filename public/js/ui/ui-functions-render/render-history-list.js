...
export function renderHistoryList(files) {
    ...
    const rows = files.map(file => {
        ...
        const action = file.missing
            ? `<button class="info-modal-row-btn" data-action="history-recreate" ${data} data-tip="recreate this file from its newest version">` +
                `<svg class="info-modal-row-icon"><use href="#icon-history-recreate"></use></svg></button>`
            : `<button class="info-modal-row-btn" data-action="history-open-file" ${data} data-tip="open this file">` +
                `<svg class="info-modal-row-icon"><use href="#icon-history-open"></use></svg></button>`;
