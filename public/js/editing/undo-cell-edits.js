 ...
 *
 * Undoing a key the edit created writes an empty value and leaves the key — v1 removes no keys, so
 * every record is the same shape and this needs no special case. §7 says why, §13.1 what it costs.
 *
